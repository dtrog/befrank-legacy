...
std::error_code Core::addBlock(const CachedBlock& cachedBlock, RawBlock&& rawBlock) {
  ...
  if (alreadyGeneratedCoins > CryptoNote::parameters::RESERVE_FUND) {
      alreadyGeneratedCoins -= CryptoNote::parameters::RESERVE_FUND;
  }
  ...
  if (minerReward != reward && (alreadyGeneratedCoins > CryptoNote::parameters::RESERVE_FUND) && (minerReward % reward < 10000)) {
