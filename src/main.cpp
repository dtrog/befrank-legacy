...
uint256 hashGenesisBlock("0x9576d7135ad081636cfab891ab4cd7ea1db9d6b3b785dc6a3ae5b05373226733");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(511316357); // BeFrank: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BeFrank Signed Message:\n";
...
{
    // BeFrank: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 480000); // BeFrank: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // BeFrank: 3.5 days
static const int64 nTargetSpacing = 150; // BeFrank: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BeFrank: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BeFrank: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // BeFrank: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbeaab12faff41a1e99232ef07b23bf5f53e021b5a3cd3f5a735d4377fd8ef932");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9dda09d5ffb7c8cccde87a360180ce8119a44b5900d4eddf1bbd5dcc0e0ef85113c0cf6bded4b617920d298749c7f043274af7855736fa494bebd34c3344678fdd") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514291216;
        block.nBits    = 511316357;
        block.nNonce   = 3470537059;

        if (fTestNet)
        {
            block.nTime    = 1514291216;
            block.nNonce   = 2578382966;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6b822ea62afa7f71431b5783ebe7afd63cf1dcdfd42e5557b7335376c9899e4a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BeFrank: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BeFrankMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BeFrankMiner : ProcessBlock, block not accepted");
    }
